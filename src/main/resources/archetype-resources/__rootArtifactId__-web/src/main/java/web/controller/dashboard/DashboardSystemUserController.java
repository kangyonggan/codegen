...
public class DashboardSystemUserController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "{username:[${symbol_escape}${symbol_escape}w]+}/delete", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
    @RequiresPermissions("SYSTEM_USER")
     ...
     * @return
     */
    @RequestMapping(value = "{id:[${symbol_escape}${symbol_escape}d]+}/undelete", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
    @RequiresPermissions("SYSTEM_USER")
     ...
     * @return
     */
    @RequestMapping(value = "{username:[${symbol_escape}${symbol_escape}w]+}", method = RequestMethod.GET)
    @RequiresPermissions("SYSTEM_USER")
