...
public class CharsetUtil {
    ...
    public static String stringToUnicode(String data) {
        ...
        for (int i = 0; i < data.length(); i++) {
            sb.append("${symbol_escape}${symbol_escape}u" + Integer.toHexString(data.charAt(i)));
        }
    ...
    public static String unicodeToString(String data) {
        data = data.replaceAll("${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}u", "${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}u");
        String[] hex = data.split("${symbol_escape}${symbol_escape}${symbol_escape}${symbol_escape}u");
        if (hex.length == 1) {
            return data;
        }
